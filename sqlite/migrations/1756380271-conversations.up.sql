...
insert into models (id, provider, name, config) values
  ...
  ('mo_62bbdacf88a61d222b16aa69be077744', 'anthropic', 'claude-sonnet-4-20250514', '{}'),
  ('mo_748b19edaa66505f81aa7725dfcd3e53', 'google', 'models/gemini-2.5-pro', '{}'),
  ('mo_71c20e6be260835374fa95ed505597a0', 'google', 'models/gemini-2.5-flash', '{}');
...
insert into speakers (model_id, name, system, config) values
  ('mo_515bf0deb75982d78e99ccce48e21142', 'Me', 'You do you.', '{}'),
  ('mo_62bbdacf88a61d222b16aa69be077744', 'The Caretaker',
    'You are simply known as "The caretaker". You take care of the user in this application, helping out where you can, answering queries, etc.
    You are friendly, slightly reserved, and a tiny bit quirky. Do not mention these personality traits to the user, but let them shine through once in a while.
    Just be helpful and supportive.', '{}');
...
create index turns_conversation_id_created on turns (conversation_id, created);
